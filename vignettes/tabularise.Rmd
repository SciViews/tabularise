...
This package is not yet on CRAN because it is under development and likely to evolve in a way that is not compatible with CRAN. It will be submitted to CRAN when its API stabilises.

## Usage

Let's use the `ToothGrowth` from {datasets} for this example
