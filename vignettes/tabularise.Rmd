...
Of couse, as the output of `tabularise()` is a **flextable** object, you can further customize it using the functions provided by {flextable}.
...
There are a couple of tables provided in {tabularise} for **data.frame**, **matrix**, oand **Correlation** objects. However, it coverage is intentionally low. Many other tables are provided in packages that depend or import {tabularise}, like:
