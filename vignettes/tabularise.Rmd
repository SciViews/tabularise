...
output:
  rmarkdown::html_vignette:
    ...
    fig_caption: yes
vignette: >
  %\VignetteIndexEntry{'SciViews::R' - Create Tabular Outputs from R}
...
Let's use the `ToothGrowth` from {datasets} for this example. You can directly add labels and units, or use `svBase::labelise()` (optional step):
